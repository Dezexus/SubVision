  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm transition-opacity">
      <div className="relative w-full max-w-lg mx-4 overflow-hidden rounded-xl bg-bg-panel shadow-panel border border-border-main sm:mx-auto animate-in fade-in zoom-in-95 duration-200">
        ...
        {/* Акцентная линия в цветах бренда */}
        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="mb-6 flex items-start gap-4">
            ...
            <div className="pt-1">
              <h2 className="text-xl font-bold tracking-tight text-txt-main">Обнаружен активный процесс</h2>
              <p className="mt-1 text-[10px] font-bold uppercase tracking-wider text-brand-400">Восстановление сеанса</p>
            </div>
          </div>
          ...
          {/* Использование глобального компонента Button */}
