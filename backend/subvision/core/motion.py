...
import cv2
import numpy as np
from subvision.core.gpu_utils import ensure_gpu, ensure_cpu, has_cuda
from subvision.core.constants import MOTION_BLUR_KSIZE, MOTION_MSE_THRESH


def detect_change_absolute(img1: Any, img2: Any, mse_thresh: float | None = None) -> bool:
    """Detect visual changes between frames using Mean Squared Error."""
    threshold = MOTION_MSE_THRESH if mse_thresh is None else mse_thresh
